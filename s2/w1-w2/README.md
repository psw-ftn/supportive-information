...
2. Klasifikacija svake klase kao "koren agregata", "entitet" ili "vrednosni objekat", gde u opštem slučaju važi:
   ...
   2. Entitet može da bude deo agregata, a da nije njegov koren, kada je jasno podređen drugom entitetu i kada ima svoj životni ciklus. Kada objekat može da se menja i potreban mu je identifikator (npr. za potrebe pronalaska datog objekta u listi objekata), kandidat je za entitet.
   3. Vrednosni objekat sadrži kohezivne podatke i logiku koja radi nad njima. Koristimo ga kada klasa nema jasan životan ciklus i jasnu potrebu za identifikatorom. Ovo ne znači da polja te klase moraju da budu nepromenljiva (engl. immutable).<br>
